...
class modExtraCategoryUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('modextra_category_err_ns');
        }
...
return 'modExtraCategoryUpdateProcessor';
