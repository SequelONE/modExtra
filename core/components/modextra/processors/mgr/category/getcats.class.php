...
class modExtraShopCategoryGetCatsProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareQueryBeforeCount(xPDOQuery $c)
    {
        ...
        if ($this->category_id) {
            $c->where(array('id' => $this->category_id));
...
return 'modExtraShopCategoryGetCatsProcessor';